...
{
    ctrl = RobotisController::GetInstance();
    ...
    op3_robot = ctrl->robot;

    ctrl->LoadOffset(offset_file_path);

    //Add Sensor Module
    ctrl->AddSensorModule((SensorModule*)CM740Module::GetInstance());


    //Add Motion Module
    ctrl->AddMotionModule((MotionModule*)BaseModule::GetInstance());
    ctrl->AddMotionModule((MotionModule*)WalkingMotionModule::GetInstance());
    ...
    get_walking_param_client = _nh.serviceClient<op3_walking_module_msgs::GetWalkingParam>("/robotis/walking/get_params", 0);
...
//
//	    if(WalkingMotionModule::GetInstance()->result[_joint_name] == NULL)
//	        _goal_position = _dxl->ConvertRadian2Value(0.0);
//	    else
//	        _goal_position = _dxl->ConvertRadian2Value(WalkingMotionModule::GetInstance()->result[_joint_name]->goal_position);
//
//
...
void DrawScreen()
{
	...
	if(WalkingMotionModule::GetInstance()->IsRunning() == true)
		printf("ON     ");
	else
		printf("OFF    ");
	...
	printf("%.1f    ", walking_param_msg.init_roll_offset*rad2deg);

	GoToCursor(PARAM_COL, PITCH_OFFSET_ROW);
	printf("%.1f    ", walking_param_msg.init_pitch_offset*rad2deg);

	GoToCursor(PARAM_COL, YAW_OFFSET_ROW);
	printf("%.1f    ", walking_param_msg.init_yaw_offset*rad2deg);

	GoToCursor(PARAM_COL, HIP_PITCH_OFFSET_ROW);
	printf("%.1f    ", walking_param_msg.hip_pitch_offset*rad2deg);
	...
	printf("%.1f    ", walking_param_msg.angle_move_amplitude*rad2deg);
	...
	printf("%.1f    ", walking_param_msg.pelvis_offset*rad2deg);
...
//        if(large == true)
//            walking_param_msg.init_roll_offset += 1.0*deg2rad;
//        else
//            walking_param_msg.init_roll_offset += 0.1*deg2rad;
//        printf("%.1f    ", walking_param_msg.init_roll_offset*rad2deg);
//        break;
//
//    case PITCH_OFFSET_ROW:
//        if(large == true)
//            walking_param_msg.init_pitch_offset += 1.0*deg2rad;
//        else
//            walking_param_msg.init_pitch_offset += 0.1*deg2rad;
//        printf("%.1f    ", walking_param_msg.init_pitch_offset*rad2deg);
//        break;
//
//    case YAW_OFFSET_ROW:
//        if(large == true)
//            walking_param_msg.init_yaw_offset += 1.0*deg2rad;
//        else
//            walking_param_msg.init_yaw_offset += 0.1*deg2rad;
//        printf("%.1f    ", walking_param_msg.init_yaw_offset*rad2deg);
//        break;
//
//    case HIP_PITCH_OFFSET_ROW:
//        if(large == true)
//            walking_param_msg.hip_pitch_offset += 1.0*deg2rad;
//        else
//            walking_param_msg.hip_pitch_offset += 0.1*deg2rad;
//        printf("%.1f    ", walking_param_msg.hip_pitch_offset*rad2deg);
//        break;
//
...
void UpdateValue(bool large, double dir)
{
	...
	case ROLL_OFFSET_ROW:
		if(large == true)
		    walking_param_msg.init_roll_offset += dir*1.0*deg2rad;
		else
		    walking_param_msg.init_roll_offset += dir*0.1*deg2rad;
		printf("%.1f    ", walking_param_msg.init_roll_offset*rad2deg);
		break;

	case PITCH_OFFSET_ROW:
		if(large == true)
		    walking_param_msg.init_pitch_offset += dir*1.0*deg2rad;
		else
		    walking_param_msg.init_pitch_offset += dir*0.1*deg2rad;
		printf("%.1f    ", walking_param_msg.init_pitch_offset*rad2deg);
		break;

	case YAW_OFFSET_ROW:
		if(large == true)
		    walking_param_msg.init_yaw_offset += dir*1.0*deg2rad;
		else
		    walking_param_msg.init_yaw_offset += dir*0.1*deg2rad;
		printf("%.1f    ", walking_param_msg.init_yaw_offset*rad2deg);
		break;

	case HIP_PITCH_OFFSET_ROW:
		if(large == true)
		    walking_param_msg.hip_pitch_offset += dir*1.0*deg2rad;
		else
		    walking_param_msg.hip_pitch_offset += dir*0.1*deg2rad;
		printf("%.1f    ", walking_param_msg.hip_pitch_offset*rad2deg);
		break;
	...
	case STEP_DIRECTION_ROW:
		if(large == true)
		    walking_param_msg.angle_move_amplitude += dir*10*deg2rad;
		else
		    walking_param_msg.angle_move_amplitude += dir*1*deg2rad;
		printf("%.1f    ", walking_param_msg.angle_move_amplitude*rad2deg);
		break;
	...
	case PELVIS_OFFSET_ROW:
		if(large == true)
		    walking_param_msg.pelvis_offset += dir*1.0*deg2rad;
		else
		    walking_param_msg.pelvis_offset += dir*0.1*deg2rad;
		printf("%.1f    ", walking_param_msg.pelvis_offset*rad2deg);
		break;
...
void MonitorCmd()
{
	...
	while(1)
	{
		value =  CM740Module::GetInstance()->result["gyro_y"];
		if(GyroFB_min > value)
			GyroFB_min = value;
		if(GyroFB_max < value)
			GyroFB_max = value;
		...
		value =  CM740Module::GetInstance()->result["gyro_x"];
		if(GyroRL_min > value)
			GyroRL_min = value;
		if(GyroRL_max < value)
			GyroRL_max = value;
		...
		value =  CM740Module::GetInstance()->result["acc_y"];
		...
		value =  CM740Module::GetInstance()->result["acc_x"];
