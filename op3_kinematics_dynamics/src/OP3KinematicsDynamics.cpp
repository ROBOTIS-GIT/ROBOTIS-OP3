...
double OP3KinematicsDynamics::TotalMass( int joint_ID )
{
    ...
    if ( joint_ID == -1 )
        ...
        _mass = op3_link_data[ joint_ID ]->mass + TotalMass( op3_link_data[ joint_ID ]->sibling ) + TotalMass( op3_link_data[ joint_ID ]->child );
...
Eigen::MatrixXd OP3KinematicsDynamics::CalcMC( int joint_ID )
{
    ...
    {
        _mc = op3_link_data[ joint_ID ]->mass * ( op3_link_data[ joint_ID ]->orientation * op3_link_data[ joint_ID ]->center_of_mass + op3_link_data[ joint_ID ]->position );
...
void OP3KinematicsDynamics::ForwardKinematics( int joint_ID )
{
    ...
    if ( joint_ID != 0 )
    {
        ...
        op3_link_data[ joint_ID ]->position =
                op3_link_data[ _parent ]->orientation * op3_link_data[ joint_ID ]->relative_position + op3_link_data[ _parent ]->position;
        op3_link_data[ joint_ID ]->orientation =
                op3_link_data[ _parent ]->orientation * Rodrigues( hatto( op3_link_data[ joint_ID ]->joint_axis ), op3_link_data[ joint_ID ]->joint_angle );
...
Eigen::MatrixXd OP3KinematicsDynamics::CalcVWerr( Eigen::MatrixXd tar_position, Eigen::MatrixXd curr_position, Eigen::MatrixXd tar_orientation, Eigen::MatrixXd curr_orientation )
{
...
bool OP3KinematicsDynamics::InverseKinematics( int to, Eigen::MatrixXd tar_position, Eigen::MatrixXd tar_orientation, int max_iter, double ik_err )
{
...
bool OP3KinematicsDynamics::InverseKinematics( int from, int to, Eigen::MatrixXd tar_position, Eigen::MatrixXd tar_orientation, int max_iter, double ik_err )
{
    bool ik_success = false;
    bool limit_success = false;
...
bool OP3KinematicsDynamics::InverseKinematics( int to, Eigen::MatrixXd tar_position, Eigen::MatrixXd tar_orientation, int max_iter, double ik_err , Eigen::MatrixXd weight )
{
    bool ik_success = false;
    bool limit_success = false;
...
bool OP3KinematicsDynamics::InverseKinematics( int from, int to, Eigen::MatrixXd tar_position, Eigen::MatrixXd tar_orientation, int max_iter, double ik_err , Eigen::MatrixXd weight )
{
    bool ik_success = false;
    bool limit_success = false;
...
bool OP3KinematicsDynamics::InverseKinematicsforLeg(double *out, double x, double y, double z, double roll, double pitch, double yaw)
{
...
bool OP3KinematicsDynamics::InverseKinematicsforRightLeg(double *out, double x, double y, double z, double roll, double pitch, double yaw)
{
...
bool OP3KinematicsDynamics::InverseKinematicsforLeftLeg(double *out, double x, double y, double z, double roll, double pitch, double yaw)
{
	if(InverseKinematicsforLeg(out, x, y, z, roll, pitch, yaw) == true) {
