...
#include "../include/op2_demo/qnode.hpp"
...
QNodeOP2::QNodeOP2(int argc, char** argv )
    : init_argc(argc)
    , init_argv(argv)
{
    // code to DEBUG
...
//    init_ft_foot_sub_ = _nh.subscribe("/robotis/base/ini_ft_value", 10, &QNodeOP2::initFTFootCallback, this);

    status_msg_sub_ = _nh.subscribe("/robotis/status", 10, &QNodeOP2::statusMsgCallback, this);
    current_module_control_sub_ = _nh.subscribe("/robotis/present_joint_ctrl_modules", 10, &QNodeOP2::refreshCurrentJointControlCallback, this);
    current_joint_states_sub_ = _nh.subscribe("/robotis/present_joint_states", 10, &QNodeOP2::updateHeadJointStatesCallback, this);
...
//    kenematics_pose_sub = _nh.subscribe("/thormang3_demo/ik_target_pose", 10, &QNodeOP2::getKinematicsPoseCallback, this);
...
//    set_walking_balance_pub = _nh.advertise<std_msgs::Bool>("/robotis/thormang3_foot_step_generator/balance_command", 0);
    ...
    // Config
    std::string _default_path = ros::package::getPath("op2_demo") +"/config/demo_config.yaml";
    std::string _path = _nh.param<std::string>("demo_config", _default_path);
    parseJointNameFromYaml(_path);

    std::string _motion_path = ros::package::getPath("op2_demo") +"/config/motion.yaml";
...
void QNodeOP2::parseJointNameFromYaml(const std::string &path)
{
    YAML::Node doc;
    try
    {
...
void QNodeOP2::parseMotionMapFromYaml(const std::string &path)
{
    YAML::Node doc;
    try
    {
...
// joint id -> joint name
bool QNodeOP2::getJointNameFromID(const int &id, std::string &joint_name)
{
...
// joint name -> joint id
bool QNodeOP2::getIDFromJointName(const std::string &joint_name, int &id)
{
...
bool QNodeOP2::getIDJointNameFromIndex(const int &index, int &id, std::string &joint_name)
{
    std::map<int, std::string>::iterator _iter;
    int _count = 0;
...
std::string QNodeOP2::getModeName(const int &index)
{
    std::string _mode = "";
...
int QNodeOP2::getModeIndex(const std::string &mode_name)
{
    int _mode_index = -1;
...
void QNodeOP2::initFTCommand(std::string command)
{
...
void QNodeOP2::setJointControlMode(const robotis_controller_msgs::JointCtrlModule &msg)
{
    module_control_pub_.publish(msg);
}

void QNodeOP2::setControlMode(const std::string &mode)
{
...
void QNodeOP2::getJointControlMode()
{
...
void QNodeOP2::refreshCurrentJointControlCallback(const robotis_controller_msgs::JointCtrlModule::ConstPtr &msg)
{
...
void QNodeOP2::updateHeadJointStatesCallback(const sensor_msgs::JointState::ConstPtr &msg)
{
...
//void QNodeOP2::initFTFootCallback(const thormang3_base_module_msgs::BothWrench::ConstPtr &msg)
//{
//    std::stringstream _ss;
...
//void QNodeOP2::calibrationFTFootCallback(const thormang3_base_module_msgs::CalibrationWrench::ConstPtr &msg) {}

void QNodeOP2::setHeadJoint(double pan, double tilt)
{
...
// Manipulation
//void QNodeOP2::sendInitPoseMsg( std_msgs::String msg )
//{
...
//void QNodeOP2::sendDestJointMsg( thormang3_manipulation_module_msgs::JointPose msg )
//{
...
//void QNodeOP2::sendIkMsg( thormang3_manipulation_module_msgs::KinematicsPose msg )
//{
...
//void QNodeOP2::sendDemoMsg( thormang3_manipulation_module_msgs::DemoPose msg )
//{
...
void QNodeOP2::getJointPose( std::string joint_name )
{
...
void QNodeOP2::getKinematicsPose (std::string group_name )
{
...
void QNodeOP2::getKinematicsPoseCallback(const geometry_msgs::Pose::ConstPtr &msg)
{
...
// Walking
//void QNodeOP2::setWalkingCommand(thormang3_foot_step_generator::FootStepCommand msg)
//{
...
//void QNodeOP2::setWalkingBalance(bool on_command)
//{
//    std_msgs::Bool _msg;
...
// Motion
void QNodeOP2::playMotion(int motion_index)
{
...
// LOG
void QNodeOP2::statusMsgCallback(const robotis_controller_msgs::StatusMsg::ConstPtr &msg)
{
    log((LogLevel) msg->type, msg->status_msg, msg->module_name);
}

void QNodeOP2::log( const LogLevel &level, const std::string &msg, std::string sender)
{
