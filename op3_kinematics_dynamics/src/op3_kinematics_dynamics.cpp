...
OP3KinematicsDynamics::OP3KinematicsDynamics(TreeSelect tree)
{
  ...
  if (tree == WholeBody)
  {
    ...
    op3_link_data_[29]->inertia_ = robotis_framework::getInertiaXYZ(0.00340499, 0.00000572, -0.00004256,
                                                                    0.00296939, -0.00000059,
                                                                    0.00317331);
    ...
    op3_link_data_[19]->inertia_ = robotis_framework::getInertiaXYZ(0.00000397, 0.0, -0.00000031,
                                                                    0.00000165, 0.0,
                                                                    0.00000387);
    ...
    op3_link_data_[20]->inertia_ = robotis_framework::getInertiaXYZ(0.00010612, 0.00000011, -0.00000910,
                                                                    0.00008721, 0.00000084,
                                                                    0.00004529);
    ...
    op3_link_data_[1]->inertia_ = robotis_framework::getInertiaXYZ(0.00000165,  0.0,        0.0,
                                                                   0.00000387, -0.00000031,
                                                                   0.00000397);
    ...
    op3_link_data_[3]->inertia_ = robotis_framework::getInertiaXYZ(0.00022804,  0.00000001, 0.00000003,
                                                                   0.00003042, -0.00000059,
                                                                   0.00023474);
    ...
    op3_link_data_[5]->inertia_ = robotis_framework::getInertiaXYZ(0.00006196, 0.0,        0.0,
                                                                   0.00001231, 0.00000372,
                                                                   0.00006854);
    ...
    op3_link_data_[2]->inertia_ = robotis_framework::getInertiaXYZ(0.00000165, 0.0,        0.0,
                                                                   0.00000387, 0.00000031,
                                                                   0.00000397);
    ...
    op3_link_data_[4]->inertia_ = robotis_framework::getInertiaXYZ(0.00022804, -0.00000001, 0.00000003,
                                                                   0.00003042, 0.00000059,
                                                                   0.00023474);
    ...
    op3_link_data_[6]->inertia_ = robotis_framework::getInertiaXYZ(0.00006196,  0.0,         0.0,
                                                                   0.00001231, -0.00000372,
                                                                   0.00006854);
    ...
    op3_link_data_[7]->inertia_ = robotis_framework::getInertiaXYZ(0.00000151, 0.0, 0.00000001,
                                                                   0.00000430, 0.0,
                                                                   0.00000412);
    ...
    op3_link_data_[9]->inertia_ = robotis_framework::getInertiaXYZ(0.00004661, 0.00000101, -0.00000131,
                                                                   0.00012523, 0.00000006,
                                                                   0.00010857);
    ...
    op3_link_data_[11]->inertia_ = robotis_framework::getInertiaXYZ(0.00010499, 0.00000001, -0.00000071,
                                                                    0.00009613, -0.00000353,
                                                                    0.00002493);
    ...
    op3_link_data_[13]->inertia_ = robotis_framework::getInertiaXYZ(0.00003715, 0.0, 0.0,
                                                                    0.00002751, 0.0,
                                                                    0.00001511);
    ...
    op3_link_data_[15]->inertia_ = robotis_framework::getInertiaXYZ(0.00004661,  0.00000101, 0.00000131,
                                                                    0.00012523, -0.00000006,
                                                                    0.00010857);
    ...
    op3_link_data_[17]->inertia_ = robotis_framework::getInertiaXYZ(0.00004034,  0.00000019, 0.00000012,
                                                                    0.00007874, -0.00000101,
                                                                    0.00011579);
    ...
    op3_link_data_[8]->inertia_ = robotis_framework::getInertiaXYZ(0.00000151, 0.0, 0.00000001,
                                                                   0.00000430, 0.0,
                                                                   0.00000412);
    ...
    op3_link_data_[10]->inertia_ = robotis_framework::getInertiaXYZ(0.00004661, -0.00000101, -0.00000131,
                                                                    0.00012523, -0.00000006,
                                                                    0.00010857);
    ...
    op3_link_data_[12]->inertia_ = robotis_framework::getInertiaXYZ(0.00010499, -0.00000001, -0.00000071,
                                                                    0.00009613,  0.00000353,
                                                                    0.00002493);
    ...
    op3_link_data_[14]->inertia_ = robotis_framework::getInertiaXYZ(0.00003715, 0.0, 0.0,
                                                                    0.00002751, 0.0,
                                                                    0.00001511);
    ...
    op3_link_data_[16]->inertia_ = robotis_framework::getInertiaXYZ(0.00004661, -0.00000101, 0.00000131,
                                                                    0.00012523,  0.00000006,
                                                                    0.00010857);
    ...
    op3_link_data_[18]->inertia_ = robotis_framework::getInertiaXYZ(0.00004034, -0.00000019, 0.00000012,
                                                                    0.00007874,  0.00000101,
                                                                    0.00011579);
...
{
  Eigen::Matrix3d R06 = robotis_framework::convertRPYToRotation(roll, pitch, yaw);
  Eigen::Vector3d p06 = robotis_framework::getTransitionXYZ(x, y, z) + ankle_length_m_*R06.block<3,1>(0,2); //desired hip to ankle
